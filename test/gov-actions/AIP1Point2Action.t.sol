...
import
    "../../src/gov-action-contracts/AIPs/AIP1Point2Action.sol"
    as a;
import "../util/ActionTestBase.sol";

contract AIP1Point2ActionTest is Test, ActionTestBase {
    function testAction() public {
        a.AIP1Point2Action action =
            new a.AIP1Point2Action(arbOneAddressRegistry);
        bytes memory callData = abi.encodeWithSelector(
            a.AIP1Point2Action.perform.selector
        );
        vm.prank(executor2);
