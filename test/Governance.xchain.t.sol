...
contract GovernanceXChainTest is Test {
    ...
    address l2Forwarder = address(1_234_567);
    ...
    function testDoesDeployGovernanceContracts() external {
        ...
        (l2Token, l2Gov, l2Timelock, l2ProxyAdmin) = l2Factory.deploy(
            l2TimelockDelay, l1TokenAddr, l2TokenLogic, initialSupply, address(this), l2TimeLockLogic, l2GovernorLogic
        );

        (l1Timelock, l1ProxyAdmin) = l1Factory.deploy(l1TimelockDelay, inbox, address(l2Timelock), l2Forwarder);
