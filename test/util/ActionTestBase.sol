...
import "../../src/gov-action-contracts/address-registries/L2GovAddressRegistry.sol" as _ar1;
...
abstract contract ActionTestBase {
    ...
    _ar1.L2GovAddressRegistry arbOneAddressRegistry;
    ...
    function setUp() public {
        ...
        new _ar1.L2GovAddressRegistry(_ar1.IL2ArbitrumGoverner(address(coreGov)), _ar1.IL2ArbitrumGoverner(address(treasuryGov)), _ar1.IFixedDelegateErc20Wallet(address(treasuryWallet)));
    }
}
