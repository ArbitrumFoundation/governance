import {
  ...
  interface L2CustomGatewayTokenInterface extends ethers.utils.Interface {
    functions: {
  ...
  export class L2CustomGatewayToken extends BaseContract {
    ...
    interface: L2CustomGatewayTokenInterface;
