...
interface L2ReverseCustomGatewayInterface extends ethers.utils.Interface {
  functions: {
...
export type TokenSetEvent = TypedEvent<[string, string] & { l1Address: string; l2Address: string }>;
...
export class L2ReverseCustomGateway extends BaseContract {
  ...
  interface: L2ReverseCustomGatewayInterface;
  ...
  filters: {
    ...
    ): TypedEventFilter<[string, string], { l1Address: string; l2Address: string }>;
