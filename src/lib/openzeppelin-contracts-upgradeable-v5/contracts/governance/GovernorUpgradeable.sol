...
import {IERC721Receiver} from "@openzeppelin-v5/contracts/token/ERC721/IERC721Receiver.sol";
import {IERC1155Receiver} from "@openzeppelin-v5/contracts/token/ERC1155/IERC1155Receiver.sol";
...
import {IERC6372} from "@openzeppelin-v5/contracts/interfaces/IERC6372.sol";
    ...
    IERC1155Receiver
{
     ...
     */
    function _validateStateBitmap(uint256 proposalId, bytes32 allowedStates)
        private
        view
