    ...
    ISecurityCouncilNomineeElectionGovernor
{
    ...
    function postUpgradeInit() external {
        require(cadenceInMonths == 0, "Cadence must be unset");
        cadenceInMonths = 6;
    }
    ...
    function setCadence(uint256 numberOfMonths, Date memory newOffsetFirstNominationStartDate) external onlyGovernance {
        _setCadence(numberOfMonths, newOffsetFirstNominationStartDate, electionCount);
    }
