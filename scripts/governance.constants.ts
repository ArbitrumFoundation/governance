...
export const L1_ARB_INBOX = "0x97f787DA0B1b59BE52c217c66ff5F6767980113c";
...
// custom token gateway on Nova (local network value atm from localNetworkNova.json)
...
// num of tokens to be sent to treasury (dummy value atm)
export const L2_NUM_OF_TOKENS_FOR_TREASURY = "9995722000";
// num of tokens to be sent to distributor (based on sum of claimable tokens in JSON file)
export const L2_NUM_OF_TOKENS_FOR_CLAIMING = "4278000";
...
export const L2_NUM_OF_RECIPIENTS = 706;
...
export const RECIPIENTS_BATCH_SIZE = 100;
// base Arb gas price of 0.1 gwei
export const BASE_L2_GAS_PRICE_LIMIT = 100000000;
// acceptable upper limit for L1 gas price - 51 gwei
export const BASE_L1_GAS_PRICE_LIMIT = 51000000000;
